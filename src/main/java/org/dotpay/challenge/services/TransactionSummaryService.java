...
public class TransactionSummaryService {
    ...
    public ResponseEntity<ResponseMessage<Object>> getTransactionSummary(String date) {
        try {
            TransactionSummary summary = transactionSummaryRepo.findByCreatedAt(date);
            return ServerResponse.successfulResponse("Transaction for specified date fetched", summary);
        } catch (Exception e) {
